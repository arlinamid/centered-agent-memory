...
Az [álom fázis](memory.hu.md#az-álom-fázis) az egyetlen rész, amihez modell kell. A telepítő nem
...
A részletek, a kézi változat és az ellenőrző parancsok: [`operations.md`](operations.hu.md#ütemezés).
